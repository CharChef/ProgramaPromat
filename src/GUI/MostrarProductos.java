...
public class MostrarProductos extends javax.swing.JFrame
{
	 ...
	 * @param _con Conexion
	 */
	public MostrarProductos(String _arg,Producto _p,Conexion _con)
	{
		super(_arg);
		setResizable(false);
		p = _p;
	...
	private void initGUI() {
		try 
		{
			...
			}
			{
				...
				jScrollPane1.setBounds(12, 99, 671, 194);
				{
					tb_productosModel = 
						new ModeloTabla(
								new String[][] {},
			...
			}
			{
				...
				jScrollPane2.setBounds(12, 304, 671, 77);
				{
			...
			this.setSize(703, 470);
			getContentPane().setLayout(null);
			
			JButton btnAniadir = new JButton("A�adir");
			OyenteBtnAniadir oba = new OyenteBtnAniadir();
			btnAniadir.addActionListener(oba);
			btnAniadir.setBounds(568, 392, 115, 23);
	...
	private class OyenteBtnAniadir implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			p.setId((int) jTable1.getValueAt(i, 1));
			p.setDescripcion((String) jTable1.getValueAt(i, 2));
			p.setPrecio((float) jTable1.getValueAt(i, 3));
			p.setMarca((String) jTable1.getValueAt(i, 4));
			p.setCategoria((String) jTable1.getValueAt(i, 5));
			p.setStock((int) jTable1.getValueAt(i, 6));
			p.setDescripcion(ta_detalle.getText());
